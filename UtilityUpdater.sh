...
latestversion=`curl -s "https://api.github.com/repos/MrDaGree/PVEDiscordDark/releases/latest" | awk -F '"' '/tag_name/{print $4}'`
...
then
    ...
    then
        echo -ne "Downloading...\n"
        wget -O "PVEDiscordDark.py" "https://raw.githubusercontent.com/MrDaGree/PVEDiscordDark/master/PVEDiscordDark.py"
        echo "$latestversion" > $file
