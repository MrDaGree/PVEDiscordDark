...
```
~# wget https://raw.githubusercontent.com/MrDaGree/PVEDiscordDark/master/PVEDiscordDark.sh
...
`REPO` is in format `Username/Repository` and defaults to `MrDaGree/PVEDiscordDark` (this repository).    
